...
class Strategy(event_handler.EventHandler):
    ...
    def add_child(self, symbol, child_strategy_id = None, child_update_freq = datetime.timedelta(seconds = 1), child_address = None):
        ...
        Args:
            ...
            child_strategy_id (str): The strategy_id to identify the (existing) child by. If none, one will be generated by uuid.uuid1()
        ...
        """
        self.children_ids[symbol] = child_strategy_id or str(uuid.uuid1())
        ...
        # Track child data
        self.datas[symbol] = lines(symbol, data_type = c.STRATEGY)
        return
