'''
Module to provide kafka-related utilities
'''
...
class KafkaHandler(logging.Handler):
    ...
    From https://stackoverflow.com/questions/21102293/how-to-write-to-kafka-from-python-logging-module
    '''


    def __init__(self, hostlist, topic = 'test', tls = None):
